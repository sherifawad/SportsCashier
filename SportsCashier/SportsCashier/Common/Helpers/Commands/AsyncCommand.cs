...
namespace SportsCashier.Common.Helpers.Commands
{
	/// <summary>
	...
	public class AsyncCommand : IAsyncCommand
	{
		...
		void ICommand.Execute(object parameter) => ExecuteAsync().SafeFireAndForget(continueOnCapturedContext, onException);
		#endregion
	}
	/// <summary>
